...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO " + Constants.TABLA_NAME_CAMP + " (ID,NAME_CAMP, DESCRIPTION,ADDRESS,PHONE,IMAGE ) VALUES (NULL, 'Metropolitano', 'capacidad de 9 contra 9','calle 34 #25-160',7243037, 'https://3dwarehouse.sketchup.com/warehouse/getpubliccontent?contentId=f07bc29e-cccd-4317-b43e-26ca44dbf1b0')");
        ...
        db.execSQL("INSERT INTO " + Constants.TABLA_NAME_CAMP + " (ID,NAME_CAMP, DESCRIPTION,ADDRESS,PHONE,IMAGE ) VALUES (NULL, 'Atanasio Girardot', 'capacidad de 7 contra 7','calle 18 #23-67',7227766, 'https://images.cdn.fourfourtwo.com/sites/fourfourtwo.com/files/styles/image_landscape/public/170816_minnesota_1.jpg?itok=aXTO0hLH')");
